...
public interface MemberRepository extends JpaRepository<Member, Long> {
    ...
    @Query("select new org.spring.pizzarazzi.dto.member.MemberLoginInfoDTO(m.email, m.nickName, m.roleType, m.address, m.zoneCode, m.detailAddress) from Member m where m.email like :email")
